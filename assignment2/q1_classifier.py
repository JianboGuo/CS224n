...
class SoftmaxModel(Model):
    ...
    def add_prediction_op(self):
        ...
        """
        ### YOUR CODE HERE
        self.W = tf.get_variable('w', shape=(self.config.n_features, self.config.n_classes),
                                 initializer=tf.truncated_normal_initializer(stddev=1.0 / self.config.n_classes ** 0.5))
        self.b = tf.get_variable('b', initializer=tf.zeros((1, self.config.n_classes)))
